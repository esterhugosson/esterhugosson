...
* 🎓 B.Sc. Computer Science, gradueated 2026)
...
## Tech Stack I have learned or exploring:
...
![React\_Native](https://img.shields.io/badge/React_Native-20232A?style=for-the-badge\&logo=react\&logoColor=61DAFB)
...
A full stack travel application where users can create and share their travel experiences using an interactive map.

**Tech:** React, Node.js, Express, MongoDB, Mapbox

### The Wine Lab

An AI-powered wine recommendation application that uses Retrieval-Augmented Generation (RAG) to provide wine recommendations and insights.

**Tech:** TypeScript, Fastify, PostgreSQL, OpenAI API, Pinecone

### Book Store

A full stack bookstore application with user and database functionality.

**Tech:** JavaScript, Node.js, MySQL, EJS
